...
document.addEventListener("DOMContentLoaded", () => {
  ...
  loadBtn.addEventListener("click", () =>
    loadDisciplina(Number(disciplinaInput.value))
  );
    ...
    try {
      if (id) {
        await fetchJson("/componentes/" + id, {
          ...
          body: JSON.stringify({ nome, sigla, descricao, disciplina_id, peso }),
        });
      } else {
      ...
      del.addEventListener("click", async () => {
        ...
        try {
          ...
          await loadDisciplina(
            Number(document.getElementById("disciplinaId").value)
          );
        } catch (err) {
          alert(err.message);
        }
        ...
        input.addEventListener("change", async () => {
          ...
          try {
            if (v == null) {
              ...
              await fetchJson("/componentes/notas", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                  aluno_id: a.id,
